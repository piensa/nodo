...
Sample `liveness` and `readiness` probe configuration in a Kubernetes `yaml` file can be found [here](https://github.com/piensa/bert/blob/master/docs/orchestration/kubernetes-yaml/minio-standalone-deployment.yaml).
