...
- You can also explore Kubernetes [Minio example](https://github.com/piensa/bert/blob/master/docs/orchestration/kubernetes-yaml/README.md) to deploy Minio using `.yaml` files.

- If you'd like to get started with Minio on Kubernetes without having to create a real container cluster, you can also [deploy Minio locally](https://raw.githubusercontent.com/piensa/bert/master/docs/orchestration/minikube/README.md) with MiniKube.
...
|----------------------------|-------------------------------------|---------------------------------------------------------|
| `image`                    | Minio image name                    | `piensa/bert`                                           |
| `imageTag`                 | Minio image tag. Possible values listed [here](https://hub.docker.com/r/piensa/bert/tags/).| `RELEASE.2018-06-29T02-11-29Z`|
...
To provision Minio servers in [shared mode](https://github.com/piensa/bert/blob/master/docs/shared-backend/README.md), set the `mode` field to `shared`,
