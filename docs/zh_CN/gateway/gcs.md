...
docker run -p 9000:9000 --name gcs-s3 \
 ...
 piensa/nodo gateway gcs yourprojectid
```
...
![Screenshot](https://github.com/piensa/nodo/blob/master/docs/screenshots/minio-browser-gateway.png?raw=true)
...
### 已知的限制
[限制](https://github.com/piensa/nodo/blob/master/docs/gateway/gcs-limitations.md)
