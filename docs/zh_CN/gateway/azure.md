...
![截图](https://github.com/piensa/nodo/blob/master/docs/screenshots/minio-browser-gateway.png?raw=true)
##使用Minio客户端 `mc`验证
...
### 已知的限制
[限制](https://github.com/piensa/nodo/blob/master/docs/gateway/azure-limitations.md)
