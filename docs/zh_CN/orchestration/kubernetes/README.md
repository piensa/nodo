# 使用Kubernetes部署Minio [![Slack](https://slack.minio.io/slack?type=svg)](https://slack.minio.io) [![Go Report Card](https://goreportcard.com/badge/piensa/nodo)](https://goreportcard.com/report/piensa/nodo) [![Docker Pulls](https://img.shields.io/docker/pulls/piensa/nodo.svg?maxAge=604800)](https://hub.docker.com/r/piensa/nodo/) [![codecov](https://codecov.io/gh/piensa/nodo/branch/master/graph/badge.svg)](https://codecov.io/gh/piensa/nodo)
...
- 你也可以浏览Kubernetes [Minio示例](https://github.com/piensa/nodo/blob/master/docs/orchestration/kubernetes-yaml/README.md) ，通过`.yaml`文件来部署Minio。

- 如果您想在Kubernetes上开始使用Minio，而无需创建真正的容器集群，您也可以使用Minikube [deploy Minio locally](https://raw.githubusercontent.com/piensa/nodo/master/docs/orchestration/minikube/README.md)。
...
| 参数                  | 描述                         | 默认值                                                 |
|----------------------------|-------------------------------------|---------------------------------------------------------|
| `image`                    | Minio镜像名称                | `piensa/nodo`                                           |
| `imageTag`                 | Minio镜像tag. 可选值在 [这里](https://hub.docker.com/r/piensa/nodo/tags/).| `RELEASE.2017-08-05T00-00-53Z`|
...
如需采用[shared mode](https://github.com/piensa/nodo/blob/master/docs/shared-backend/README.md)部署Minio, 将`mode` 设为`shared`,
